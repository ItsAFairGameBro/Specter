...
GuiTbl.FromGame.Name = "FromGame"
GuiTbl.FromGame.Parent = GuiTbl.TabsSelection
GuiTbl.FromGame.BackgroundColor3 = Color3.fromRGB(255, 170, 0)
GuiTbl.FromGame.BorderColor3 = Color3.fromRGB(0, 0, 0)
GuiTbl.FromGame.BorderSizePixel = 0
GuiTbl.FromGame.LayoutOrder = -1
GuiTbl.FromGame.Size = UDim2.new(0, 200, 0, 50)
GuiTbl.FromGame.ZIndex = 103
GuiTbl.FromGame.FontFace = Font.new("rbxasset://fonts/families/IndieFlower.json",Enum.FontWeight.Bold,Enum.FontStyle.Normal)
GuiTbl.FromGame.Text = "All"
GuiTbl.FromGame.TextColor3 = Color3.fromRGB(255, 255, 255)
GuiTbl.FromGame.TextScaled = true
GuiTbl.FromGame.TextSize = 14.000
GuiTbl.FromGame.TextStrokeTransparency = 0.000
GuiTbl.FromGame.TextWrapped = true

GuiTbl.UICorner_17.CornerRadius = UDim.new(0, 32)
GuiTbl.UICorner_17.Parent = GuiTbl.FromGame

GuiTbl.UIStroke_18.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
GuiTbl.UIStroke_18.Parent = GuiTbl.FromGame
...
GuiTbl.Friends.Name = "Friends"
GuiTbl.Friends.Parent = GuiTbl.TabsSelection
GuiTbl.Friends.BackgroundColor3 = Color3.fromRGB(34, 255, 0)
GuiTbl.Friends.BorderColor3 = Color3.fromRGB(0, 0, 0)
GuiTbl.Friends.BorderSizePixel = 0
GuiTbl.Friends.LayoutOrder = 1
GuiTbl.Friends.Size = UDim2.new(0, 200, 0, 50)
GuiTbl.Friends.ZIndex = 103
GuiTbl.Friends.FontFace = Font.new("rbxasset://fonts/families/IndieFlower.json",Enum.FontWeight.Bold,Enum.FontStyle.Normal)
GuiTbl.Friends.Text = "Friends"
GuiTbl.Friends.TextColor3 = Color3.fromRGB(255, 255, 255)
GuiTbl.Friends.TextScaled = true
GuiTbl.Friends.TextSize = 14.000
GuiTbl.Friends.TextStrokeTransparency = 0.000
GuiTbl.Friends.TextWrapped = true

GuiTbl.UICorner_20.CornerRadius = UDim.new(0, 32)
GuiTbl.UICorner_20.Parent = GuiTbl.Friends

GuiTbl.UIStroke_21.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
GuiTbl.UIStroke_21.Parent = GuiTbl.Friends
...
GuiTbl.ExtraLabel.Text = "Only public servers in this universe are visible; player count or server status may not be up to date"
