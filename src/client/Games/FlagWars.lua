                        ...
                        if C.char then
                            ...
                            if HasFlag then
                                ...
                                elseif os.clock()-LastTouch >= 7 then
                                    C.DoTeleport(AllyFlag.Position + TeleportOffset + Vector3.new(C.Randomizer:NextNumber(-3,3),C.Randomizer:NextNumber(-2,-2),C.Randomizer:NextNumber(-3,3)))
                                ...
                                if os.clock() - LastGet >= 3 then
                                    ...
                                    if DropFlag then
                                        ...
                                        C.DoTeleport(DropFlag.Position + TeleportOffset + Vector3.new(C.Randomizer:NextNumber(-1,1),C.Randomizer:NextNumber(-2,2),C.Randomizer:NextNumber(-1,1)))
                                    else
                                        actionClone.Time.Text = "Base Steal"
                                        C.DoTeleport(EnemyFlag.Position + TeleportOffset + Vector3.new(C.Randomizer:NextNumber(-3,3),C.Randomizer:NextNumber(-2,2),C.Randomizer:NextNumber(-3,3)))
                                    end
                                else
