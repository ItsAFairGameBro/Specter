		...
		Tab = {
			...
			},
			{
				...
				FontTranslations = {
					...
					["Letter Font 1"] = {Input = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789.,:;'"!?-_/+*=()%@#$&^~`,
						Output = { "🅐", "🅑", "🅒", "🅓", "🅔", "🅕", "🅖", "🅗", "🅘", "🅙", "🅚", "🅛", "🅜", "🅝", "🅞", "🅟", "🅠", "🅡", "🅢", "🅣", "🅤", "🅥", "🅦", "🅧", "🅨", "🅩", "🅐", "🅑", "🅒", "🅓", "🅔", "🅕", "🅖", "🅗", "🅘", "🅙", "🅚", "🅛", "🅜", "🅝", "🅞", "🅟", "🅠", "🅡", "🅢", "🅣", "🅤", "🅥", "🅦", "🅧", "🅨", "🅩", "⓿", "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒", ".", ",", ":", ";", "'", '"', "!", "?", "-", "_", "/", "+", "*", "=", "(", ")", "%", "@", "#", "$", "&", "^", "~" }
					},
					["Small Font 1"] = {Input = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789.,:;'"!?-_/+*=()%@#$&^~`,
				...
				Options = {
					{
						Type = Types.Dropdown,
						Selections = {"Off","Fancy Unicode Font 1","Letter Font 1","Small Font 1"},
						Title = "Font Bypass",
