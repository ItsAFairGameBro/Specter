		...
		Tab = {
			{
				...
				RunCheck = function(self,instanceData)
					...
					print(theirInGame[3],theirInGame[3]~=nil,C.isinGame(camera.CameraSubject.Parent),(theirInGame[3]~=nil and C.isinGame(camera.CameraSubject.Parent)==theirInGame[1]))
